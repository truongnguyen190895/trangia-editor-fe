...
interface HDDatCocContextType {
  partyA: AgreementParty;
  partyB: AgreementParty;
  agreementObject: HdDatCocPayload | null;
  ...
  //   Common section
  addAgreementObject: (object: HdDatCocPayload) => void;
  deleteAgreementObject: () => void;
}

export const HDDatCocContext = createContext<HDDatCocContextType>({
...
export const useHDDatCocContext = () => useContext(HDDatCocContext);

export const HDDatCocProvider = ({
  children,
}: {
  ...
  const [agreementObject, setAgreementObject] =
    useState<HdDatCocPayload | null>(null);
  ...
  const addAgreementObject = (object: HdDatCocPayload) => {
