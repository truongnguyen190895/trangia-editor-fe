import type {
  ...
  interface HDCNDatVaTaiSanGanLienVoiDatToanBoContextType {
  ...
  export const HDCNDatVaTaiSanGanLienVoiDatToanBoContext = createContext<HDCNDatVaTaiSanGanLienVoiDatToanBoContextType>({
  ...
  export const useHDCNDatVaTaiSanGanLienVoiDatToanBoContext = () => useContext(HDCNDatVaTaiSanGanLienVoiDatToanBoContext);
  
  export const HDCNDatVaTaiSanGanLienVoiDatToanBoProvider = ({
    children,
  }: {
    ...
    return (
      <HDCNDatVaTaiSanGanLienVoiDatToanBoContext.Provider
        value={{
          agreementObject,
          taiSan,
