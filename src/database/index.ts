...
export const templates = [
  ...
  {
    id: uuidv4(),
    name: "HĐ tặng cho đất và tài sản gắn liền với đất (toàn bộ).docx",
    type: "agreement",
    subCategory: "nhom-tang-cho",
    path: "hd-tang-cho-toan-bo-dat-va-tsglvd",
    templateId: 0,
  },
  {
    id: uuidv4(),
    name: "HĐ tặng cho đất và TSGLVD một phần (đồng sử dụng).docx",
    type: "agreement",
    subCategory: "nhom-tang-cho",
    path: "hd-tang-cho-dat-va-tsglvd-mot-phan-de-dong-su-dung",
    templateId: 0,
  },
  {
    id: uuidv4(),
    name: "HĐ tặng cho đất và TSGLVD một phần (sử dụng toàn bộ).docx",
    type: "agreement",
    subCategory: "nhom-tang-cho",
    path: "hd-tang-cho-dat-va-tsglvd-mot-phan-de-su-dung-toan-bo",
    templateId: 0,
  },
  {
    id: uuidv4(),
