...
import { render_hdcn_dat_va_tai_san_gan_lien_voi_dat_toan_bo } from "@/api";
...
export const HDCNDatVaTaiSanGanLienVoiDatToanBo = () => {
  const { partyA, partyB, agreementObject, taiSan } = useHDCNDatVaTaiSanGanLienVoiDatToanBoContext();
